...
/* Returns the result of multiplying the given Vector by the given scalar */
...
/* Returns the reuslt of dividing the given Vector by the given scalar */
...
/* Constructs the vector which transforms Point A to B */
